...
for(const name of ['custom-records.js','english-content.js','english-mocks.js','english-papers.js','english-app.js'])vm.runInContext(fs.readFileSync('dist/'+name,'utf8'),context);
